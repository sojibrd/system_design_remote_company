...
রিমোট নিয়োগ মানে দূর থেকে বিশ্বাস কেনা — ওরা আপনাকে দেখে না, পড়ে। এই দুই সপ্তাহে তিনটা লেখা, তিনটাই ইংরেজিতে: **`srdtube`-এর ছয় সেকশনের design doc** আর নিজের static সাইটের **frontend design note** — এই দুটো প্রকাশ হয়; আর আবেদনের তালিকার একটা কোম্পানির **ফিচারের design note** — অন্য কোম্পানির প্রোডাক্ট নিয়ে, তাই প্রকাশ নয়, নিজের কাছে আলোচনার প্রস্তুতি। লোকালে যা প্রস্তুতি, এখানে তা জমা দেওয়ার মতো নমুনা। 🧠 (Skill stacking · Have an endpoint)

শেষ দিনে থামা — তিনটার পরে নতুন লেখা নয়, এখন থেকে ঝালাই আর আবেদনের চিঠিতে লিংক। 🧠 (10,000 hours rule)

> **ব্লক শেষে:** তিনটা ইংরেজি লেখা — দুটো প্রকাশিত — আর একটা কোম্পানির ফিচারের ১০ মিনিটের রেকর্ডিং?
